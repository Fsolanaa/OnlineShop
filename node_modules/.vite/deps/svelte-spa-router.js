import "./chunk-2W4TOZAH.js";
import {
  derived,
  readable,
  writable
} from "./chunk-X2YRGGRO.js";
import "./chunk-APL7M3ZG.js";
import {
  afterUpdate,
  bubble_event,
  check_target,
  ...
  prop,
  spread_props
} from "./chunk-HFTK3IQI.js";
import "./chunk-UMPGGVPL.js";
import "./chunk-4R5CFKUQ.js";
import {
  append,
  comment
} from "./chunk-DVWIMJ3A.js";
import {
  FILENAME,
  HMR,
  deep_read_state,
...
async function replace(location2) {
  ...
  try {
    ...
    console.warn(...log_if_contains_state("warn", "Caught exception while replacing the current page. If you're running this in the Svelte REPL, please note that the `replace` method might not work in this environment."));
  }
...
function Router($$anchor, $$props) {
  ...
  class RouteItem {
    ...
    async checkConditions(detail) {
      for (let i = 0; i < this.conditions.length; (i += 1) - 1) {
  ...
  let component2 = mutable_state(null);
  let componentParams = mutable_state(null);
  let props = mutable_state({});
